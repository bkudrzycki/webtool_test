neet <- read.csv(here("lamadex", "data","raw","neet_sex_ilostat.csv"))
unemployment_rate <- read.csv(here("lamadex", "data","raw","unemployment_rate_sex_age_ilostat.csv"))

employed <- read.csv(here("lamadex", "data","raw","employed_sex_edu_ilostat.csv"))

unemployed <- read.csv(here("lamadex", "data","raw","unemployed_sex_edu_ilostat.csv"))

working_pov <- read.csv(here("lamadex", "data","raw","workingpoverty_sex_ilostat.csv"))

underemp <- read.csv(here("lamadex", "data","raw","underemployment_sex_ilostat.csv"))

informal <- read.csv(here("lamadex", "data","raw","informality_age_sex_Bonnet.csv")) %>%
...
status <- read.csv(here("lamadex", "data","raw","employment_sex_status_ilostat.csv"))

occupation <- read.csv(here("lamadex", "data","raw","occupation_sex_age_ilostat.csv"))

education <- read.csv(here("lamadex", "data","raw","education_sex_dhs.csv")) %>%
...
literacy <- read.csv(here("lamadex", "data","raw","literacy_sex_unesco.csv")) %>%
  rename("ref_area.label" = Country,
         "obs_value" = Value,
         "time" = Time)
...
test_scores <- read.csv(here("lamadex", "data","raw","test_scores_sex_wb.csv")) %>%
